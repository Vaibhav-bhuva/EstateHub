"""
Property models stored in both SQLite (for Django ORM) and synced to MongoDB.
"""
...
class Property(models.Model):
    ...
    STATUS_CHOICES = [
        ('available', 'Available'), ('sold', 'Sold'), ('rented', 'Rented'), ('archived', 'Archived')
    ]
    FURNISHED_CHOICES = [
    ...
    ai_estimated_price = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True)
    ...
    # Tags/amenities stored as JSON text
