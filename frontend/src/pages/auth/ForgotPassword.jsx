    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="glass-card p-8 text-center">
          ...
          {sent ? (
            <>
              <p className="text-gray-500 text-sm mb-6">Check your inbox for the OTP and proceed to reset your password.</p>
              <Link to="/reset-password" state={{ email: watch('email') }} className="btn-primary block text-center">Enter OTP & Reset</Link>
            </>
          ) : (
            <>
